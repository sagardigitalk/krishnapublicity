...
export default function CityHoardingsPage() {
  ...
  if (!city) {
    return (
      <div className="container mx-auto px-4 py-16 bg-theme-cream min-h-screen text-theme-navy flex flex-col items-center justify-center">
  ...
  return (
    <div className="container mx-auto px-4 py-16 bg-theme-cream min-h-screen text-theme-navy">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {city.hoardings.map((hoarding: Hoarding) => (
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <Card className="h-full flex flex-col justify-between overflow-hidden bg-white shadow-sm border border-theme-navy/10 hover:border-theme-navy/30 hover:shadow-lg transition-all duration-300 group">
              <CardHeader className="pb-4">
                <CardTitle className="text-xl font-bold text-center text-theme-navy transition-colors">
                  {hoarding.title}
                </CardTitle>
              </CardHeader>
              <CardContent>
                ...
                >
                  ...
                  <a
                    ...
                    className="absolute top-2 right-2 bg-white rounded-full p-2 shadow-md transition-transform duration-300 ease-in-out transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-theme-navy focus:ring-opacity-50"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <MapPin className="h-6 w-6 text-theme-navy" />
                  </a>
                </div>

                <p className="text-sm text-theme-navy/70 mb-3">{hoarding.description}</p>
              ...
              <CardFooter className="flex justify-center pt-4 pb-6">
                <Button
                  className="hover:shadow-lg transition-all rounded-xl px-8 py-2 h-auto border-none bg-theme-navy text-white hover:bg-theme-navy/90"
      ...
      {selectedHoarding && (
        ...
        >
          ...
          >
            ...
            />
            <p className="text-theme-navy/70 mb-6 text-lg">{selectedHoarding.description}</p>
