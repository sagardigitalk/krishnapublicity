        ...
        <div className="space-y-6">
          <div className="bg-[#1B2642] p-8 rounded-3xl text-white shadow-xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-sm font-bold tracking-widest uppercase text-white/50">Live Preview Info</h3>
            </div>
            <p className="text-sm leading-relaxed text-white/90">
              Changes made here will instantly update the "Gujarat's Most Reliable Advertising Family" section on the Homepage upon saving.
            </p>
          </div>
        </div>
