          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 text-gray-500 text-sm border-b border-gray-100 whitespace-nowrap">
                <th className="px-6 py-4 font-medium">પ્રોડક્ટનું નામ</th>
                <th className="px-6 py-4 font-medium">વિગત</th>
                <th className="px-6 py-4 font-medium">કસ્ટમરનું નામ</th>
              ...
              {loading ? (
                ...
                entries.map(entry => (
                  <tr key={entry._id} className="hover:bg-gray-50/50">
                    <td className="px-6 py-4 font-medium text-[#1B2642]">{entry.productName}</td>
                    <td className="px-6 py-4 text-gray-600 max-w-[200px] truncate">{entry.details}</td>
                    <td className="px-6 py-4 text-gray-600">{entry.customerName}</td>
